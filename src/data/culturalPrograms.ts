...
export const culturalPrograms: CulturalProgram[] = [
  ...
  },
  {
    ...
    country: 'Estados Unidos',
    tagline: 'Trabaja en escuelas de EE. UU. y fortalece tu perfil profesional.',
    description:
    ...
    benefits: [
      ...
      'Comparte tu cultura y aprende nuevas metodologías',
      'Desarrolla tus habilidades lingüísticas en un entorno real',
      'Vive y trabaja en EE. UU. mientras te preparas para el futuro',
    ],
    duration: 'La duración se confirma según la oferta laboral asignada y las condiciones del programa.',
    keyFacts: ['Seguro de emergencias incluido', 'Asignación de una oferta laboral', 'Asesoría durante el proceso de aplicación'],
    image: {
    ...
    faq: [
      {
        ...
        answer: 'Puedes aplicar desde sexto semestre o hasta máximo 12 meses después de graduarte de una licenciatura en cualquier carrera académica.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Incluye seguro de emergencias, asignación de una oferta laboral y asesoría durante el proceso de aplicación.',
      },
    ],
    pricing: {
      badge: 'Inscripción',
      headline: 'Teacher Assistant',
      items: ['Valor de la inscripción: $250.000 COP'],
    },
  },
  {
    slug: 'aupair',
