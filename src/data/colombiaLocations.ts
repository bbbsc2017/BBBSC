...
// Lista única de universidades/empresas tal como están registradas en Clientify.
// Se usa igual sin importar el departamento para evitar que se generen duplicados
// en el campo "Empresa / Universidad" de Clientify por variaciones de escritura.
export const UNIVERSITIES: string[] = [
  ...
  'Univiersidad San Buenaventura',
  'Juzgado cuarto Municipal de pequeñas causas laborales de Ibague',
  'UNAM - Universidad Autonoma de Manizales',
  'UT - Universidad Del Tolima',
  'UPTC - Universidad Pedagogica y Tecnologica de Colombia',
  'ECIJG - Escuela Colombiana De Ingenieria Julio Garavito',
  'UTP - Universidad Tecnologica de Pereira',
  'UNIROSARIO - Universidad un Rosario',
  'Universidad de Sucre',
  'UCC - Universidad Cooperativa de Colombia',
  'UNIBAGUE - Universidad de Ibague',
  'UNINORTE - Universidad del Norte',
  'IBERO - Corporacion Universitaria Iberoamericana',
  'Universidad de Cordoba',
  'Universidad Central',
  'Institucion Universitaria Escuela Nacional del Deporte',
  'Fundacion universitaria Comfamiliar Risaralda',
  'Escuela naval de cadetes almirante padilla',
  'UNILIBRE - Universidad Libre de Colombia - Socorro',
  'FESC - Fundacion de Estudios Superiores Comfanorte',
  'Colombia college',
  'PROYECTOS Y SERVICIOS COMBEIMA SAS',
  'Universidad ECCI',
  'NUEVA GEA SAS',
  'UPN - Universidad Pedagogica Nacional',
  'CORHUILA - Corporacion Universitaria del Huila Corhuila',
  'UNAULA - Universidad Autonoma Latinoamericana',
  ...
  'UDI - Universitaria De Investigacion Y Desarrollo',
  'UNAB - Universidad Autonoma de Bucaramanga',
  'UDES - Universidad de Santander',
  'UMB - Universidad Manuela Beltran - BGA',
  'USTA - Universidad Santo Tomas de Aquino - BOG',
  'UNICESAR - Universidad Popular del Cesar',
  'UFPS - Universidad Francisco de Paula Santander',
  'UNILLANOS - Universidad de los Llanos',
  'Conservatorio del Tolima - IES',
  'ULASALLE - Universidad de La Salle',
  'Universidad EAFIT',
  'UCOMPENSAR - Universidad compensar',
  'UAO - Universidad Autonoma del Occidente',
  'UPILOTO - Universidad Piloto de Colombia',
  'Universidad de Pamplona',
  'ESAP - Escuela Superior de Administracion Publica',
  'UTS - Unidades Tecnologicas de Santander',
  'UAN - Universidad Antonio Narino',
  'Corporacion Universitaria Remington',
  'Universidad de Manizales',
  'AREANDINA - Fundacion Universitaria del Area Andina',
  'UCALDAS - Universidad De Caldas',
  'ITFIP - Instituto tolimense de formacion tecnica profesional',
  'POLI - Politecnico Grancolombiano Instituto Universitaria',
  'UTADEO - Universidad Jorge Tadeo Lozano',
  'UDCA - Universidad de ciencias aplicadas y ambientales',
  'Universidad de la Amazonia',
  'UNIBAC - Institucion Universitaria Bellas Artes y Ciencias de Bolivar',
  'Universidad Colegio Mayor de Cundinamarca',
  'UNISANGIL - Fundacion Universitaria de San Gil',
  'BBB - Student Center',
  ...
  'Colorworking Bucaramanga',
  'UNITROPICO - Universidad internacional del Tropico Americano',
  'JUZGADO QUINTO DE PAZ IBAGUE',
  'UCO - Universidad Catolica de Oriente',
  'COLMAYOR - Instituto Universitaria Colegio Mayor de Antioquia',
  'Fundacion Universitaria Los Libertadores',
  'UNITEC - Corporacion Universitaria UNITEC',
  'Juzgado Sexto Civil municipal',
  'United pool management',
  'CTI - Corporacion Educativa Indoamericana',
  'UMC - Universidad de Cervantes',
  'USANJOSE - Fundacion de Educacion Superior San Jose',
  'UCM - Universidad Catolica de Manizales',
  'UDEB - Universidad de Boyaca',
  'Mayan Monkey',
